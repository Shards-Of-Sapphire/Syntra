...
export default function Dashboard() {
  ...
  const averageScore = events.length ? events.reduce((sum, event) => sum + (event.sentiment_score ?? 0), 0) / events.length : 0;
